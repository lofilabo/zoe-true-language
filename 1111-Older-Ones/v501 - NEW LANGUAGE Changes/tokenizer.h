...
static const char *keywords[] = {
	...
	"zoe_and_this",       	/* TT_ANYR */		/* You Did This! 'AN YR' -> 'zoe_and_this'   	---LATEST - > ''  */	
	"zoe_do_maths_with",    /* TT_AN */		/* You Did This! 'AN' -> 'zoe_do_maths_with'   	---LATEST - > ''  */	
	...
	"zoe_call_now",        	/* TT_MKAY */		/* You Did This! 'MKAY' -> 'zoe_call_now'   	---LATEST - > ''  */
	"ALL OF",      		/* TT_ALLOF */
	"ANY OF",      		/* TT_ANYOF */
	...
	"toysoldiers",      	/* TT_SMOOSH */	     	/* You Did This! 'SMOOSH' -> 'toysoldiers'	---LATEST - > ''  */
	"!",           		/* TT_BANG */
	...
	"NERFIN",      		/* TT_NERFIN */
	"zoe_pass_this",	/* TT_YR */		/* You Did This! 'YR' -> 'zoe_pass_this'	---LATEST - > ''  */
	...
	"zoe_return_from_function",    /* TT_FOUNDYR */	/* You Did This! 'FOUND YR' -> 'zoe_return_from_function'   ---LATEST - > ''  */	
	"SRS",         		/* TT_SRS */
	"--arrMember-->",       /* TT_APOSTROPHEZ */  	/* You Did This! "'Z" -> '--arrMember-->'   	---LATEST - > ''  */
	"O HAI IM",    		/* TT_OHAIIM */		/* You Did This! "" -> ''   			---LATEST - > ''  <------NOT YET EVEN STARTED*/
	"IM LIEK",     		/* TT_IMLIEK */		/* You Did This! "" -> ''   			---LATEST - > ''  <------NOT YET EVEN STARTED*/
	"KTHX",        		/* TT_KTHX */		/* You Did This! "" -> ''   			---LATEST - > ''  <------NOT YET EVEN STARTED*/
	"I DUZ",       		/* TT_IDUZ */		/* You Did This! "" -> ''   			---LATEST - > ''  <------NOT YET EVEN STARTED*/
	"CAN HAS",     		/* TT_CANHAS */		/* You Did This! "" -> ''   			---LATEST - > ''  <------NOT YET EVEN STARTED*/
